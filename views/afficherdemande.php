        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
              <?php
                                            ...
                                            $userParPage =6;
                                            $userTotalReq=$bdd->query('SELECT Id FROM demande');
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <!--                <th scope="col">id</th> -->
                            ...
                            <tbody>
                              <?PHP
                              $listeUsers=$bdd->query('SELECT * FROM demande ORDER BY Id DESC LIMIT '.$depart.','.$userParPage);
                                ...
                                <td>  <input type="checkbox" id="show">
                                     ...
                                     <div class="container">
                                       <form method="POST" action="supprimerdemande.php">
                                         <h7>veillez vous supprimer cette demande ?</h7><br>
                                        ...
                                        <label for="show" class="close-btn fas fa-times" title="close"></label>
                        					...
                        					<td>
                                    <a href="modifierdemande.php?id=<?PHP echo $demande['Id']; ?>" ><i class="fa fa-edit" style="font-size: 26px;"></i></a>
                        					</td>
                        ...
                        for($i=1;$i<=$pagesTotales;$i++){
                            ...
                            <?php
                              ...
                              ?>
                            <li class="page-item"><?php   echo '<a class="page-link" href="afficherdemande.php?page='.$i.'">'.$i.'</a> '; ?></li>
                            <?php
                          }
                        }
                        ?>
